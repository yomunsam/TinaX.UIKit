...
namespace TinaX.UIKit
{
    public class UIManager : IUIKit, IUIKitInternal
    {
        ...
        public IUIEntity OpenUI<T>(string UIName, OpenUIParam openUIParam, params object[] args) where T : XBehaviour
        {
            string ui_path = null;
            if (mUINameMode == UINameMode.UIGroup)
            {
        ...
        public IUIEntity OpenUIWithBehaviourType(string UIName, Type xBehaviourType, params object[] args)
        {
            string ui_path = null;
            if (mUINameMode == UINameMode.UIGroup)
            {
        ...
        public IUIEntity OpenUIWithBehaviourType(string UIName, Type xBehaviourType, OpenUIParam openUIParam, params object[] args)
        {
            string ui_path = null;
            if (mUINameMode == UINameMode.UIGroup)
            {
        ...
        public async Task<IUIEntity> OpenUIAsync<T>(string UIName, OpenUIParam openUIParam, params object[] args) where T : XBehaviour
        {
            string ui_path = null;
            if (mUINameMode == UINameMode.UIGroup)
            {
        ...
        public async Task<IUIEntity> OpenUIWithBehaviourTypeAsync(string UIName, Type xBehaviourType, params object[] args)
        {
            string ui_path = null;
            if (mUINameMode == UINameMode.UIGroup)
            {
        ...
        public async Task<IUIEntity> OpenUIWithBehaviourTypeAsync(string UIName, Type xBehaviourType, OpenUIParam openUIParam, params object[] args)
        {
            string ui_path = null;
            if (mUINameMode == UINameMode.UIGroup)
            {
        ...
        public void OpenUIWithBehaviourTypeAsync(string UIName, Type xBehaviourType, Action<IUIEntity, XException> callback, params object[] args)
        {
            this.OpenUIWithBehaviourTypeAsync(UIName, xBehaviourType, args)
                .ToObservable()
                .ObserveOnMainThread()
                .Subscribe(entity =>
                {
        ...
        public void OpenUIWithBehaviourTypeAsync(string UIName, Type xBehaviourType, OpenUIParam openUIParam, Action<IUIEntity, XException> callback, params object[] args)
        {
            this.OpenUIWithBehaviourTypeAsync(UIName, xBehaviourType, openUIParam, args)
                .ToObservable()
                .ObserveOnMainThread()
                .Subscribe(entity =>
                {
